...
bind("SUPER", "D", exec_cmd("pkill rofi || true; $HOME/.config/hypr/scripts/RofiFocusedWallpaperLink.sh >/dev/null 2>&1 || true; rofi -show drun -modi drun, filebrowser, run, window -config $HOME/.config/hypr/rofi/config.rasi"), { description = "App launcher" })
...
bind("SUPER CTRL", "S", exec_cmd("$HOME/.config/hypr/scripts/RofiFocusedWallpaperLink.sh >/dev/null 2>&1 || true; rofi -show window -config $HOME/.config/hypr/rofi/config.rasi"), { description = "Window switcher" })
...
bind("SUPER CTRL", "G", exec_cmd("$HOME/.config/hypr/scripts/Ghostty_themes.sh"), { description = "Ghostty theme selector" })
...
bind("SUPER CTRL", "SPACE", exec_cmd("$HOME/.config/hypr/scripts/float.all.samesize.lua"), { description = "Float all windows same size" })
...
bind("SUPER SHIFT", "O", exec_cmd("$HOME/.config/hypr/scripts/ZshChangeTheme.sh"), { description = "Change ZSH (oh-my-zsh) theme" })
...
bind("SUPER", "j", exec_cmd("$HOME/.config/hypr/scripts/LayoutKeybindDispatch.sh cycle-next"), { description = "Cycle next (layout-aware)" })
bind("SUPER", "k", exec_cmd("$HOME/.config/hypr/scripts/LayoutKeybindDispatch.sh cycle-prev"), { description = "Cycle previous (layout-aware)" })
...
bind("", "xf86MonBrightnessDown", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --dec"), { description = "Brightness down", locked = true, ["repeat"] = true })
bind("", "xf86MonBrightnessUp", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --inc"), { description = "Brightness up", locked = true, ["repeat"] = true })
bind("CTRL ALT", "equal", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --inc"), { description = "Increase brightness", locked = true, ["repeat"] = true })
bind("CTRL ALT", "minus", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --dec"), { description = "Decrease brightness", locked = true, ["repeat"] = true })
bind("CTRL ALT", "KP_Add", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --inc"), { description = "Increase brightness", locked = true, ["repeat"] = true })
bind("CTRL ALT", "KP_Subtract", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --dec"), { description = "Decrease brightness", locked = true, ["repeat"] = true })
...
bind("SUPER", "left", exec_cmd("$HOME/.config/hypr/scripts/LayoutKeybindDispatch.sh focus-left"), { description = "Focus left (layout-aware)" })
bind("SUPER", "right", exec_cmd("$HOME/.config/hypr/scripts/LayoutKeybindDispatch.sh focus-right"), { description = "Focus right (layout-aware)" })
bind("SUPER", "up", exec_cmd("$HOME/.config/hypr/scripts/LayoutKeybindDispatch.sh focus-up"), { description = "Focus up (layout-aware)" })
bind("SUPER", "down", exec_cmd("$HOME/.config/hypr/scripts/LayoutKeybindDispatch.sh focus-down"), { description = "Focus down (layout-aware)" })
...
bind("SUPER CTRL", "tab", exec_cmd("$HOME/.config/hypr/scripts/toggle-qs-hyprview.sh 'smartgrid'"), { description = "Hyprview Toggle" })
...
bind("", "xf86KbdBrightnessDown", exec_cmd("$HOME/.config/hypr/scripts/BrightnessKbd.sh --dec"), { description = "Decrease keyboard brightness", locked = true, ["repeat"] = true })
bind("", "xf86KbdBrightnessUp", exec_cmd("$HOME/.config/hypr/scripts/BrightnessKbd.sh --inc"), { description = "Increase keyboard brightness", locked = true, ["repeat"] = true })
bind("", "xf86Launch1", exec_cmd("rog-control-center"), { description = "ASUS Armory crate button" })
bind("", "xf86Launch3", exec_cmd("asusctl led-mode -n"), { description = "Switch keyboard RGB profile" })
bind("", "xf86Launch4", exec_cmd("asusctl profile -n"), { description = "Change fan profiles" })
bind("", "xf86MonBrightnessDown", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --dec"), { description = "Decrease monitor brightness", locked = true, ["repeat"] = true })
bind("", "xf86MonBrightnessUp", exec_cmd("$HOME/.config/hypr/scripts/Brightness.sh --inc"), { description = "Increase monitor brightness", locked = true, ["repeat"] = true })
bind("", "xf86TouchpadToggle", exec_cmd("$HOME/.config/hypr/scripts/TouchPad.sh"), { description = "Toggle touchpad" })
